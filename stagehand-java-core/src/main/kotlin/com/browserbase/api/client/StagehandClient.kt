...
interface StagehandClient {
     ...
     */
    fun withOptions(modifier: Consumer<ClientOptions.Builder>): StagehandClient
    ...
    interface WithRawResponse {
         ...
         * The original service is not modified.
         */
        fun withOptions(modifier: Consumer<ClientOptions.Builder>): StagehandClient.WithRawResponse
