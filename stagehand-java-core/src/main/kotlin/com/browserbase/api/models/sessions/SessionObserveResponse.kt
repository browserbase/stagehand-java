...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): SessionObserveResponse =
            SessionObserveResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionObserveResponse && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SessionObserveResponse{additionalProperties=$additionalProperties}"
}
