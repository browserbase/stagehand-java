...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): SessionEndResponse = SessionEndResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionEndResponse && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SessionEndResponse{additionalProperties=$additionalProperties}"
}
