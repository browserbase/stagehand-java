...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): SessionActResponse = SessionActResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionActResponse && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SessionActResponse{additionalProperties=$additionalProperties}"
}
