...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(sessionExecuteAgentParams: SessionExecuteAgentParams) = apply {
            id = sessionExecuteAgentParams.id
            xLanguage = sessionExecuteAgentParams.xLanguage
            xSdkVersion = sessionExecuteAgentParams.xSdkVersion
            xSentAt = sessionExecuteAgentParams.xSentAt
            xStreamResponse = sessionExecuteAgentParams.xStreamResponse
            body = sessionExecuteAgentParams.body
    ...
    override fun toString() =
        "SessionExecuteAgentParams{id=$id, xLanguage=$xLanguage, xSdkVersion=$xSdkVersion, xSentAt=$xSentAt, xStreamResponse=$xStreamResponse, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
