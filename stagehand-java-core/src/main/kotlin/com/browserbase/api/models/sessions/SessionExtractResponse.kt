...
private constructor(private val additionalProperties: MutableMap<String, JsonValue>) {
    ...
    class Builder internal constructor() {
        ...
        fun build(): SessionExtractResponse =
            SessionExtractResponse(additionalProperties.toMutableMap())
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SessionExtractResponse && additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() = "SessionExtractResponse{additionalProperties=$additionalProperties}"
}
