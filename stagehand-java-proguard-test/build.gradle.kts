...
dependencies {
    testImplementation(project(":stagehand-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../stagehand-java-core/src/main/resources/META-INF/proguard/stagehand-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../stagehand-java-core/src/main/resources/META-INF/proguard/stagehand-java-core.pro",
