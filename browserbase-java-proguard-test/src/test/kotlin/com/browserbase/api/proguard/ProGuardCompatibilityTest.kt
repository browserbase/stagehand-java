...
internal class ProGuardCompatibilityTest {
    ...
    fun proguardRules() {
        val rulesFile =
            javaClass.classLoader.getResourceAsStream("META-INF/proguard/browserbase-java-core.pro")
    ...
    @Test
    fun client() {
        val client = BrowserbaseOkHttpClient.builder().apiKey("My API Key").build()
