...
dependencies {
    testImplementation(project(":browserbase-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../browserbase-java-core/src/main/resources/META-INF/proguard/browserbase-java-core.pro")
}
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../browserbase-java-core/src/main/resources/META-INF/proguard/browserbase-java-core.pro",
