...
private constructor(
     ...
     *
     * Use the one published in `browserbase-java-client-okhttp` or implement your own.
     *
    ...
    class Builder internal constructor() {
         ...
         */
        fun fromEnv() = apply {
            (System.getProperty("browserbase.baseUrl") ?: System.getenv("BROWSERBASE_BASE_URL"))
                ?.let { baseUrl(it) }
            (System.getProperty("browserbase.stagehandApiKey")
                    ?: System.getenv("STAGEHAND_API_KEY"))
                ?.let { apiKey(it) }
        }
